      ...
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Finemeとは何ですか？', acceptedAnswer: { '@type': 'Answer', text: 'Finemeは男性向けの外見改善プラットフォームです。外見を起点に自信を再設計するための診断・AI分析・ガイドマッチングを提供しています。' } },
              ...
              { '@type': 'Question', name: '男性が外見を改善するには何から始めればいいですか？', acceptedAnswer: { '@type': 'Answer', text: 'まずはMe Scan（無料診断）で自分の「Finemeコンパス（最優先の一手）」を把握することをおすすめします。一般的には眉毛の整え・髪型・体型・服装の順が効果的です。' } },
              ...
              { '@type': 'Question', name: '男性の髪型はどう選べばいいですか？', acceptedAnswer: { '@type': 'Answer', text: '顔型（丸・面長・卵型など）と輪郭に合わせた髪型を選ぶことが基本です。美容師に「顔型に合わせてください」と伝えるだけで大きく変わります。月1回のカットを習慣化することも重要です。' } },
              { '@type': 'Question', name: '男性ファッションで最初に抑えるべきことは？', acceptedAnswer: { '@type': 'Answer', text: 'まずシルエット（サイズ感）です。どんなブランドでも、体に合ったサイズ感で着るだけで清潔感が上がります。次にベーシックなカラー（白・グレー・紺・黒）の服を揃えることをおすすめします。' } },
