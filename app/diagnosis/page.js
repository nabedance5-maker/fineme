...
import { AXIS_HABIT_ITEM_LABELS, CLEANSE_FREQ_LABELS, BODY_FREQ_LABELS, BODY_PART_LABELS, HAIR_SALON_FREQ_LABELS } from '@/lib/axis-habits';
...
export default function DiagnosisPage() {
  ...
  useEffect(() => {
    ...
    // 軸ごとの「今の具体的行動」multi-select。hairだけアイテムとスタイリングを分けて表示する
