...
export default function DiagnosisResultPage() {
  ...
  useEffect(() => {
    ...
    const TYPE_DESCRIPTION = {
      // ── B軸（体型） ──
      BNV:'体型を意識したことがほとんどない。それだけ変えられる余白が大きいということだ。まず自分の現在地を数値で知ることから始めよう。最初の計測が地図になる。',
      BNK:'体型について客観的なフィードバックを受けたことがない。自分では気づきにくい死角がある。一度体組成を測り、プロの目で現状を確認してみよう。',
      BND:'体型を気にせず、淡々と体を動かしている。それが最も持続可能な状態だ。目的意識より習慣化が先。気づいたとき、大きく変わっている。',
      BCV:'体型が気になっている。でも何から始めればいいかわからない。まず食事か歩数か睡眠か、一つだけ変える。全部じゃなくていい。',
      BCQ:'以前トレーニングを始めたが続かなかった。続けられなかったのは意志の問題ではない。続けられる仕組みを先に設計する。それだけで変わる。',
      BCK:'体型が気になって自分なりに取り組んでいる。頑張りは本物だ。でも方向が正しいかは別の話。一度プロに見てもらい、努力を正しい場所に向ける。',
      BCL:'以前は体づくりをしていた。今は止まっている。でも一度動けた体はまた動ける。再開のハードルは最初より低い。小さく再開するだけでいい。',
      BCD:'体型改善に向けて今まさに動いている。変容の途中にある。焦らず、でも止まらず。続けることが最大の戦略だ。',
      BAV:'自分でトレーニングや食事管理をしている。でもパーソナルトレーナーに頼ったことはない。一度だけ使ってみると、独学の限界と可能性が同時に見える。',
      BAQ:'自分でトレーニングしていたが、一度やめた。再開できない理由を一つだけ特定する。仕組みさえ整えれば、また動き出せる。',
      BAK:'自分流で体を鍛えている。センスはある。でも独学には盲点がある。フォームか栄養か、一つだけプロに確認するだけで効果が変わる。',
      BAL:'以前は自分でしっかり体を管理していた。今は一時停止中。体の記憶は消えない。小さく再開するだけで戻るのは早い。',
      BAD:'自分でトレーニングや食事管理をしながら、今まさに動いている。この状態が最も伸びる。変化を記録すると、さらに加速できる。',
      BPQ:'パーソナルトレーナーやジムに通っていたが今は辞めた。その経験は確実に体に残っている。戻るタイミングが来たとき、以前より速く結果が出る。',
      BPK:'トレーナーに頼りながらも、自己流な部分がある。プロとの対話をもっと活かす。疑問点をすべて聞く。投資に見合う結果を引き出そう。',
      BPL:'プロのサポートで体づくりをしていたが、今は止まっている。再開の意志があるなら、まず以前のトレーナーに連絡するだけでいい。',
      BPD:'プロのサポートを受けながら、今まさに体と向き合っている。これ以上ない状態だ。次のフェーズは、変わった体を外の場で試すことだ。',
      // ── E軸（眉） ──
      ENV:'眉を整えたことがない。でも眉は顔の印象を最も短時間・低コストで変えられる部位だ。1回のサロンで別人のような変化を体感できる。試す価値が最も高い軸だ。',
      ENK:'眉について客観的に評価されたことがない。自分では気づきにくいズレがある。一度だけサロンでデザインしてもらい、正解の形を知ろう。',
      END:'眉を気にせず、自分なりに手入れしている。習慣化できているのは強みだ。一度プロに形を作ってもらうと、自己管理の精度がさらに上がる。',
      ECV:'眉が気になっている。でもサロンへのハードルを感じている。眉サロンは30分以下、数千円から。まず予約だけ入れてみよう。',
      ECQ:'眉サロンか自己処理を一度したが続かなかった。正しい形を一度作ると、その後の維持が楽になる。まずサロンで「設計」だけしてもらうのが近道だ。',
      ECK:'眉が気になって自分で整えている。でもセルフ眉は角度・太さ・左右差のズレが出やすい。1回サロンで基準を作ると、セルフの精度が大きく上がる。',
      ECL:'以前は眉を整えていたが今は放置している。眉の印象への影響力は大きい。週1回の簡単なケアを再開するだけで顔の印象が戻る。',
      ECD:'眉ケアに今まさに取り組んでいる。最も即効性のある軸で動いている。定期サロンと自己管理を組み合わせると、印象の安定感が増す。',
      EAV:'自分で眉を整えているがサロンに行ったことがない。一度プロに形を作ってもらうと、基準点ができてセルフが劇的に楽になる。',
      EAQ:'自分で眉を整えていたが一度やめた。眉は放置すると印象への影響が大きい。眉ペンシル一本から再開しよう。',
      EAK:'自分流で眉を整えている。センスはあるはずだ。でも鏡では気づきにくい骨格とのズレがある。1回のサロンで正解の形を学ぶと、その後が変わる。',
      EAL:'以前は眉ケアをしっかりしていた。今は放置している。眉は顔の中で最も印象への影響力が高い。少しの手入れで大きく戻る。',
      EAD:'自分で眉を整えながら、今まさに力を入れている。プロの技術で土台を作り、その上に自己管理を乗せるとさらに精度が上がる。',
      EPQ:'眉サロンに通っていたが辞めた。その時に作られた形が基準になっているはずだ。再開すれば、以前より短期間でベストな状態に戻れる。',
      EPK:'プロに通いながらも、希望通りの仕上がりになっていない可能性がある。担当者に遠慮せず希望を伝える。コミュニケーションが仕上がりを変える。',
      EPL:'プロレベルの眉ケアの経験がある。今は止まっている。眉は定期的なメンテナンスで成立する。再開のタイミングを作るだけでいい。',
      EPD:'眉サロンに通いながら、今まさにケアを続けている。最も即効性の高い軸を手に入れている。次は、整った眉を土台にした全体の印象管理に目を向けよう。',
      // ── F軸（服装・ファッション） ──
      FNV:'服装をほとんど気にしたことがない。ファッションは外見の中で最も「選択」で変えられる軸だ。体型より服の選び方の方が印象を変える。まず一着だけ見直してみよう。',
      FNK:'服装について客観的なフィードバックを受けたことがない。自分では気づきにくいミスコーデがある。一度だけショップスタッフに見てもらおう。',
      FND:'服を気にせず、自分なりに選んでいる。それで成立しているなら強みだ。一度整理してみると、もっと少ない服で高い印象を出せることがわかる。',
      FCV:'服装が気になっている。何を買えばいいかわからない状態だ。まず今持っている服を全部出して並べてみる。持っているものを知ることが最初の地図だ。',
      FCQ:'服装を改善しようとしたことがあるが続かなかった。一気に変えようとすると失敗しやすい。まず「捨てる」ことから始めると、全体が動き出す。',
      FCK:'服装が気になって自分なりに工夫している。でもルール化できていないと迷い続ける。色・サイズ・素材の基本3軸だけ整えると一気に変わる。',
      FCL:'以前は服装に気を使っていた。今は流れで着ている。一着だけ意識して選んでみる。その一着が、残りの服の使い方を変える。',
      FCD:'服装改善に今まさに取り組んでいる。即日変化が出る軸だ。買い足すより捨てることを先にすると、全体の精度が上がる。',
      FAV:'自分なりにコーデをしているがスタイリストに頼ったことがない。一度だけパーソナルスタイリングを受けると、自分に合う「型」がわかる。その後の判断が速くなる。',
      FAQ:'自分でコーデを工夫していたが一度やめた。センスは落ちない。また少し意識するだけで戻れる。まず一着だけ、今の自分に合うものを選んでみよう。',
      FAK:'自分流のスタイルがある。それは資産だ。でも外の目で見るとズレが見えることがある。率直なフィードバックを一度もらうと、独自性と清潔感が両立できる。',
      FAL:'以前はしっかりファッションを楽しんでいた。今は惰性で着ている。クローゼットを整理するだけで、また楽しめる状態になる。',
      FAD:'自分でスタイリングしながら今まさに力を入れている。一番大事なのは「絞る」ことだ。着回せるアイテムを増やすと、毎日の質が上がる。',
      FPQ:'スタイリストやパーソナルショッピングに頼っていたが辞めた。その時に学んだ自分の型は残っているはずだ。再開すれば以前より速く洗練される。',
      FPK:'プロのサポートを受けながらも、自己流な部分が残っている。プロの提案を実生活に落とし込むのが次の課題だ。気になる点を素直に相談してみよう。',
      FPL:'パーソナルスタイリングを受けた経験がある。今は止まっている。その経験を活かして今のクローゼットを見直すだけで、投資を回収できる。',
      FPD:'プロのサポートを受けながら、今まさにファッションを磨いている。次は写真映りや第一印象で実際に確認する場に出てみよう。',
      // ── H軸（髪） ──
      HNV:'髪をほとんど気にしたことがない。でも髪型は第一印象の30%を決める。一度だけ美容師に任せてみよう。その一回で、自分に似合う形がわかる。',
      HNK:'髪について客観的なフィードバックをもらったことがない。自分では判断しにくい死角がある。次の美容院で「似合う髪型にしてください」と一言だけ言ってみよう。',
      HND:'髪を気にせず、自分のペースで整えている。習慣化できているのは強みだ。次は「誰に切ってもらうか」にこだわるだけで、同じ習慣が別の結果を生む。',
      HCV:'髪が気になっている。でもどこに行けばいいかわからない。まず一つだけ美容院を探して予約する。それだけでいい。行ってみると想像より変わる。',
      HCQ:'以前カットやスタイリングを変えようとしたが続かなかった。髪は定期的なメンテナンスが必要な軸だ。次は「何ヶ月ごとに行く」という仕組みを先に作ろう。',
      HCK:'髪が気になって自分なりにスタイリングしている。でも根本の形が合っていないと、スタイリングで補いきれない。一度美容師にカットの形から相談してみよう。',
      HCL:'以前は髪にこだわっていた。今は流れで切っている。美容院を変えるだけで大きく変わることがある。次の一回を、少し調べてから予約してみよう。',
      HCD:'髪型改善に今まさに取り組んでいる。印象変化が最も早く出る軸を動かしている。次は、その髪型を維持するためのホームケアを整えよう。',
      HAV:'自分でスタイリングはしているが、プロ美容師に「似合う形」を作ってもらったことがない。一度だけヘアスタイリストに任せてみよう。骨格・顔型の基準が手に入る。',
      HAQ:'自分で髪をケアしていたが一度やめた。髪は放置すると印象への影響が大きい。まず美容院の予約を一つ入れる。それだけで再起動できる。',
      HAK:'自分流でスタイリングしている。こだわりがあるのは強みだ。でも第三者の目から見ると違う答えが出ることがある。一度だけプロに任せると、新しい基準ができる。',
      HAL:'以前はしっかり髪をケアしていた。今は少し放置している。その経験があるから再開は早い。次の美容院の予約を入れるだけで動き出せる。',
      HAD:'自分でケアしながら、今まさに髪に力を入れている。担当美容師を固定すると、さらに精度が上がる。「次もお願いします」の一言が変化を加速させる。',
      HPQ:'プロの美容師に定期的に通っていたが辞めた。担当美容師か、サロンが合わなくなったのかもしれない。自分に合う美容師を探し直すだけで、また変われる。',
      HPK:'美容師に通いながらも、希望が伝えきれていない可能性がある。美容師との対話が仕上がりを決める。次回は「こうなりたい」を写真で持参してみよう。',
      HPL:'プロレベルの髪ケアの経験がある。今は止まっている。髪は放置すると印象がすぐ変わる。再開のタイミングを一つ決めよう。',
      HPD:'美容師に通いながら、今まさに髪を磨いている。外見の中で最も印象に直結する軸を動かしている。次は頭皮ケアやホームケアを加えて品質をさらに上げよう。',
      // ── S軸（肌） ──
      SNV:'肌ケアをほとんどしたことがない。でも肌は近距離の印象を最も左右する軸だ。洗顔と保湿の2ステップだけ始めよう。それだけで全体の印象が変わる。',
      SNK:'肌について客観的に評価されたことがない。自分では見えにくい肌質の問題がある。一度だけ皮膚科か化粧品カウンターで肌診断を受けると、正しいケアがわかる。',
      SND:'肌を気にせず、自分なりにケアしている。継続できているのは最大の強みだ。次は成分を少し意識するだけで、同じ習慣がより高い結果を生む。',
      SCV:'肌が気になっている。でも何から始めればいいかわからない。まず洗顔方法を正しくするだけで変わる。洗いすぎか、洗えていないか、そこから確認しよう。',
      SCQ:'肌ケアを一度始めたが続かなかった。スキンケアは続けやすい仕組みにすることが全てだ。商品数を2つに絞ると、続きやすくなる。',
      SCK:'肌が気になって自分なりにケアしている。でも自己流は迷走しやすい。一度皮膚科か信頼できるカウンセラーに今のルーティンを見せてみよう。',
      SCL:'以前は肌ケアをしていた。今は流れでやっている。肌への投資対効果は高い。一度ルーティンを整え直すだけで戻れる。',
      SCD:'肌改善に今まさに取り組んでいる。継続が成果に直結する軸だ。焦らず、一つのルーティンを90日続けよう。',
      SAV:'自分でスキンケアはしているがプロに頼ったことがない。一度だけエステや皮膚科に行くと、今のケアの正解度がわかる。独学の限界と突破口が見えてくる。',
      SAQ:'自分でスキンケアしていたが一度やめた。肌は放置すると印象の土台が崩れる。まず洗顔だけ再開する。それだけでいい。',
      SAK:'自分流のスキンケアルーティンがある。継続は強みだ。今使っている化粧水・乳液の成分を一度確認してみよう。合っていれば加速する。',
      SAL:'以前はスキンケアをしっかりやっていた。今は少し怠けている。一番簡単なステップから戻るだけでいい。肌への影響が出る前に再開しよう。',
      SAD:'自分でスキンケアしながら今まさに力を入れている。大事なのは「引き算」だ。商品を増やすより、正しいルーティンを絞ることが近道になる。',
      SPQ:'エステや皮膚科に通っていたが辞めた。その時に改善されたものは確実に残っている。ホームケアを維持するだけで、その成果を守れる。',
      SPK:'プロのケアを受けながらも、効果を実感できていない部分がある。何が改善されていて、何が変わっていないかを言語化して担当者に伝えよう。',
      SPL:'プロレベルの肌ケア経験がある。今は止まっている。その知識は消えない。ホームケアだけでも再起動できる。',
      SPD:'プロのサポートを受けながら肌を磨いている。最も清潔感の土台に直結する軸を動かしている。次は睡眠・食事・ストレス管理との連動を意識しよう。',
      // ── T軸（歯・笑顔） ──
      TNV:'歯のケアをほとんど気にしたことがない。でも笑顔と口元は第一印象の核心だ。まず歯科検診に行くだけでいい。自分の口元の現状を知ることから始まる。',
      TNK:'歯について客観的なフィードバックを受けたことがない。自分では気づきにくい口元の印象がある。一度だけ歯科医か歯科衛生士に相談してみよう。',
      TND:'歯を気にせず、自分なりにケアしている。基本的な習慣があるのは強みだ。そこにホワイトニングやフロスを一つ加えるだけで、印象が底上げされる。',
      TCV:'歯や笑顔が気になっている。でも歯科は費用や時間のハードルを感じる。まず近くの歯科でクリーニングだけ受けてみよう。それだけで口元の清潔感が変わる。',
      TCQ:'歯のケアや矯正を一度考えたが続かなかった。歯は「やり切ると一生続く」軸だ。まず小さく、歯科クリーニングから再開してみよう。',
      TCK:'歯が気になって自分なりにケアしている。でも自己流には限界がある。プロフェッショナルクリーニングを一度受けると、自己ケアの正しい方向がわかる。',
      TCL:'以前は歯のケアをしていた。今は惰性になっている。口元の清潔感は印象に直結する。フロスを一本買うだけで再起動できる。',
      TCD:'歯・笑顔の改善に今まさに取り組んでいる。笑顔に自信が出ると、人との距離が変わる。その変化を実感できる場に出てみよう。',
      TAV:'自分で歯磨きケアはしているがプロの施術を受けたことがない。一度だけ歯科クリーニングを受けると、自己ケアでは取れない汚れが取れ、印象が変わる。',
      TAQ:'自分でケアしていたが一度やめた。口内の健康は印象だけでなく健康全体に影響する。まず歯磨きの時間を30秒延ばすだけで再起動できる。',
      TAK:'自分流の口元ケアをしている。継続は強みだ。でも正しいブラッシング法ができているか確認が必要だ。一度歯科衛生士に磨き方を見てもらおう。',
      TAL:'以前は歯のケアをしっかりやっていた。今は基本だけになっている。週一回のフロスから再開しよう。口元の清潔感は印象への影響が大きい。',
      TAD:'自分でケアしながら、今まさに歯・笑顔に力を入れている。3ヶ月に1回の定期的な歯科メンテナンスを習慣にすると、この状態を維持できる。',
      TPQ:'歯科・ホワイトニング等のプロ施術を経験したが今は通っていない。その変化は本物だ。メンテナンスだけでも継続すれば、その成果は守れる。',
      TPK:'プロのケアを受けながらも、効果の実感が薄い可能性がある。何が変わっていて、何が足りないかを担当医に率直に聞こう。',
      TPL:'プロレベルの歯・口元ケアの経験がある。今は止まっている。笑顔は外見で最も「場の空気」を変える要素だ。再開のタイミングを一つ決めよう。',
      TPD:'プロのサポートを受けながら歯・笑顔を磨いている。笑顔の自信は行動量を変える。整えた笑顔を、実際の出会いや写真で積極的に使っていこう。',
      // ── W軸（爪・手元） ──
      WNV:'爪や手元を気にしたことがない。手元は近距離での清潔感を決める。まず爪を清潔に整えるだけでいい。それだけで印象が静かに変わる。',
      WNK:'手元について客観的に気にしたことがない。爪の長さ・形・清潔感は他人の目には意外と見えている。一度だけネイルケアサロンでベースケアを受けてみよう。',
      WND:'爪や手元を気にせず、自分なりに整えている。その習慣は静かに信頼感を作っている。次は甘皮処理やネイルオイルを一つ加えると、印象の質が上がる。',
      WCV:'爪や手元が気になっている。でも何から始めればいいかわからない。まずネイルファイルで形を整えるだけでいい。小さなところから始められる変化がある。',
      WCQ:'以前ネイルケアを始めたが続かなかった。道具を手元に置くだけで続きやすくなる。まず爪やすりを一本、洗面台に置いてみよう。',
      WCK:'爪が気になって自分なりにケアしている。でも自己流には限界がある。一度ネイルケアサロンでベース処理をしてもらうと、その後のセルフケアが劇的に楽になる。',
      WCL:'以前は爪や手元を気にしていた。今は流れになっている。手元は近距離の印象に直結する。爪を切って整えるだけで戻れる。',
      WCD:'爪・手元の改善に今まさに取り組んでいる。細部の仕上がりが全体の質感を決める。定期的なネイルケアサロンのメンテナンスを仕組み化しよう。',
      WAV:'自分で爪を整えているがネイルサロンに行ったことがない。一度だけサロンでベースケアを受けると、自己ケアの正解がわかる。その後のセルフが変わる。',
      WAQ:'自分でケアしていたが一度やめた。手元はすぐ乱れて、すぐ戻せる軸でもある。爪切りとヤスリだけで再起動できる。',
      WAK:'自分流で爪・手元を整えている。こだわりは強みだ。一度プロの仕上がりを見てみると、新しい基準が手に入る。その基準がセルフを底上げする。',
      WAL:'以前はしっかり爪・手元を整えていた。今は少し放置している。手元は再開が最も速い軸だ。爪切り一本で今すぐ戻れる。',
      WAD:'自分でケアしながら、今まさに手元に力を入れている。次はネイルオイルで保湿を習慣化しよう。細部へのこだわりが全体の印象を底上げする。',
      WPQ:'ネイルサロンに通っていたが辞めた。その時の手元の変化は本物だった。メンテナンスのみに絞って再開する選択肢もある。',
      WPK:'ネイルサロンに通いながらも、効果を十分に感じていない可能性がある。担当者に希望の仕上がりと今の不満を率直に伝えよう。伝えるだけで変わる。',
      WPL:'プロレベルの手元ケアの経験がある。今は止まっている。手元は他軸に比べて再開コストが低い。次の予約を一つ入れるだけで動き出せる。',
      WPD:'プロのサポートを受けながら手元を磨いている。細部が整うと全体の質感が変わる。次は手元を「見せる」意識を持って、日常の中で活用していこう。',
    };
