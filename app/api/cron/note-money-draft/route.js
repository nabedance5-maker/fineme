...
・⑥独自メソッド＝「すごいアイデアは要らない。Claude CodeにやりたいことをAIに指示して、毎日勝手に進む仕組みを1個ずつ積む」
・⑨手順＝Claude Codeに"作りたい仕組み"を言葉で指示して作らせる流れ／今日できる小さな自動化1個、を再現できる粒度で（Make/Zapier/n8n等の外部ツールは使わない・紹介しない）
