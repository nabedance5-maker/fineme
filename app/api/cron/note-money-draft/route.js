...
以下を①〜⑫の型に溶け込ませ、読者の「欲しい」を購入直前まで積み上げる。トーンはでおの温かい×正直な声を保ちつつ、少しエッジ（断定・熱量）を効かせてよい。ただし嘘・不安の煽り・読者や過去の自分への嘲笑はしない。
・冒頭は"手に入る未来"から入る：ノウハウ説明より先に「これができると、あなたの毎日はこう変わる」という憧れの情景を鮮明に描く（未来ペーシング）
・読者の欲求と痛みを"あなたの言葉"で言語化して自己投影させる（「〜したいですよね？」「〜な経験、ありませんか？」）
・"隠れたメカニズム"を匂わせる：「稼げてる個人は、実はほぼ全員"ある同じこと"をやってる」＝好奇心＋FOMO（※事実の範囲で。断定しすぎない）
・"憧れの未来"のベネフィットを畳みかける箇条書き（「〜できる」「〜になる」を並べて情景を積む）
・"今のままでいいか？"の軽い自己変革ナッジを1回だけ置く（前向きな後押しに留める。脅し・自己否定はしない）
・購入直前で特典を"リビール"して価値を跳ね上げる（後出しのプレゼント感で「そこまで付くなら」を作る）
・全体を通して「この先にもっとすごいものがある」という前傾を切らさない
...
⑦ 無料パートは"入口・触り"だけ（★"無料で手に入る感"は絶対に出さない）
　- ★禁止語：「ここまでが無料」「無料のまとめ」「無料で全部見せます／出します」「出し惜しみしない」等、"無料で全部手に入る"と感じさせる文言は一切書かない（読者が"タダで済む"と思い購入が遠ざかる）
　- 無料で見せるのは「なぜそうなるかの考え方の"一部"」と「最初の触り」だけ。価値は感じさせるが、"全部出した感"を出さない
　- 常に「本当に効く道具・全手順・プロンプト全文・テンプレはこの先にある」と感じさせ、"本題はまだ先"の前傾を作る
⑧ 有料の境界＝"前傾の一線"（★「ここまでが無料」ではなく「ここからが本題」）
　- 区切りは「ここから先が本当に価値のある部分／ここからが本題」と前傾で書く。「ここまでが無料のまとめ」とは絶対に書かない
...
　- ★各手順は「これができると、収益化にこう近づく」という一言を添えて、作業→お金の線を切らさない
⑩ 反論処理＋リスクリバーサル
