...
const STORY_CONTEXTS = [
  { seed: '追う男ほど女は冷める', hint: '好意より、余裕のなさが漏れた瞬間にアウト。追わない=興味がないではない' },
  { seed: '女は「好きバレ」で冷めるんじゃない、必死感で冷める', hint: '好意は見せていい。ただし引ける男だけが刺さる' },
  { seed: '返信の速さより「余白」で好意は伝わる', hint: '即レスの連投は重い。間を怖がらない男に女は反応する' },
...
const PHILOSOPHY_CONTEXTS = [
  { theme: '女が喜ぶLINE', angle: '褒め連打より「見てくれてる」が伝わる一言が刺さる' },
  { theme: '女の性欲スイッチが入る言葉', angle: '決めつけ・観察から出た一言・沈黙を埋めない余裕' },
  { theme: 'デートで好感度が上がる行動', angle: '会えた瞬間・別れ際のもう一押しなど、細部が効く' },
  { theme: '女が冷める男の言動', angle: '必死感・自分語り・機嫌伺い・追いすぎ' },
  { theme: 'モテる見た目の要素', angle: '体脂肪・眉・髪・清潔感の下地。顔より土台' },
  { theme: '女が惚れる瞬間', angle: '手が届きそうで届かない・本性を見抜かれた感覚' },
];
...
- 断定・持論でOK（例:「女はね、〜が大好きなんだよ」「余裕のなさが漏れた瞬間にアウト」）。ただし人格否定・差別・過度に性的/下品は避ける
