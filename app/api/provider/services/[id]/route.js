...
export async function PATCH(request, { params }) {
  ...
  const allowed = ['name','description','price','duration','duration_minutes','is_featured','sort_order','image_url','suitable_path_types','transformation_promise','target_axis','before_text','after_text','before_image_url','after_image_url','benefit_list','category'];
  const updates = {};
