        ...
        <section style={{ padding: '80px 24px', background: 'var(--color-bg)', borderTop: '1px solid rgba(201,168,76,0.12)' }}>
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                { q: 'Finemeとは何ですか？', a: 'Finemeは男性向けの外見改善プラットフォームです。外見を起点に自信を再設計するための診断・AI分析・ガイドマッチングを提供しています。' },
                { q: 'Me Scanとは何ですか？料金はかかりますか？', a: 'Me Scanは無料の7軸外見診断です。眉毛・髪・体型・服・肌・歯・爪の7軸を問診形式でスキャンし、あなたの「最優先の一手（Finemeコンパス）」を特定します。所要時間は12〜18分で、無料でご利用いただけます。' },
                ...
                { q: '男性が外見を改善するには何から始めればいいですか？', a: 'まずはMe Scan（無料診断）で自分の「Finemeコンパス（最優先の一手）」を把握することをおすすめします。一般的には眉毛の整え・髪型・体型・服装の順が効果的です。' },
                { q: '外見改善の正しい順番はありますか？', a: 'Finemeでは7軸をTier分類しています。Tier1（即効性高）：眉毛・髪・体型・服 → Tier2：肌 → Tier3：歯・口元 → Tier4：爪。眉毛がコスト・時間・効果のコスパで最優先です。' },
                { q: '清潔感を出すにはどうすればいいですか？', a: '清潔感の土台は眉毛・髪・肌の3つです。特に眉毛は最も即効性が高く、1〜2回のサロン施術で劇的に印象が変わります。次に髪型を整え、肌のスキンケアを日課にすることをおすすめします。' },
                { q: '垢抜けるとはどういうことですか？', a: '垢抜けとは「清潔感のある外見 + 自分の体型・顔に合ったスタイルの確立」です。特定のトレンドを追うのではなく、自分に似合う形・色を把握することが重要です。' },
                { q: '外見改善にかかる費用はどのくらいですか？', a: '眉サロン（初回¥3,000〜）から始めれば最低限の費用で大きな変化が得られます。全体的には月¥10,000〜¥30,000程度の継続投資でかなりの変化が期待できます。' },
                { q: '外見改善で最も効果が高いのは何ですか？', a: '眉毛の整えが最も高いコストパフォーマンスを発揮します。1〜2回のサロン施術で顔の印象が大きく変わり、効果が長続きするためです。次に髪型、体型の順です。' },
                { q: '眉毛を整えるにはどうすればいいですか？', a: '初回は眉サロンに行くことを強くおすすめします。自己流では左右差や形の失敗リスクが高いためです。サロンで形を作ってもらった後、自宅でのメンテナンスに移行するのが最短で綺麗な眉を手に入れる方法です。' },
                { q: '男性の髪型はどう選べばいいですか？', a: '顔型（丸・面長・卵型など）と輪郭に合わせた髪型を選ぶことが基本です。美容師に「顔型に合わせてください」と伝えるだけで大きく変わります。月1回のカットを習慣化することも重要です。' },
                { q: '男性ファッションで最初に抑えるべきことは？', a: 'まずシルエット（サイズ感）です。体に合ったサイズ感で着るだけで清潔感が上がります。次にベーシックなカラー（白・グレー・紺・黒）の服を揃えることをおすすめします。' },
                { q: '肌荒れを改善するには何から始めればいいですか？', a: '洗顔・保湿・日焼け止めの3ステップを毎日続けることが基本です。洗顔のしすぎは乾燥を招くため、朝は水洗いだけでもOKです。改善しない場合は皮膚科の受診をおすすめします。' },
                { q: 'マッチングアプリでマッチしない原因は何ですか？', a: '最大の原因はプロフィール写真です。特に「清潔感が伝わるか」「表情が親しみやすいか」「背景が散らかっていないか」の3点が重要です。' },
                { q: 'マッチングアプリの写真を改善する方法は？', a: '自然光の下で、清潔感のある服装で、笑顔の写真を撮ることが基本です。Fineme Mirrorを使えばAIが写真の改善点を具体的にフィードバックします。' },
                { q: 'ジムに行く前にやるべきことは？', a: '眉毛・髪・服の整え（Tier1）を先に行うことをおすすめします。体型改善は効果が出るまで数ヶ月かかりますが、眉毛や髪型は数週間で大きく変わります。投資対効果の高い順に取り組むことが合理的です。' },
                { q: '外見と自己肯定感の関係は？', a: '外見改善は自己肯定感を高める有効な手段の一つです。鏡を見るたびに「なんか違う」という感覚が消えることで、行動の自信につながります。見た目を変えることは「自分が変われる」という体験を積むことでもあります。' },
                { q: '外見改善で恋愛は変わりますか？', a: 'はい、大きく変わります。特にマッチングアプリでは写真の印象が全てと言っても過言ではありません。外見改善によって「自分から動ける自信」が生まれることも恋愛への大きな影響です。' },
                { q: 'AIで外見を分析するにはどうすればいいですか？', a: 'Fineme Mirrorをご利用ください。写真を1枚アップロードするだけで、AIが外見を7軸（眉毛・髪・体型・服・肌・歯・爪）で分析し、改善点を具体的に提案します。' },
              ].map(({ q, a }, i) => (
