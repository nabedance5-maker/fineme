export const metadata = {
  title: '全119タイプ一覧 — New Me Type Map | Fineme',
  description: 'Finemeの外見変容診断が出力する全119タイプを一覧表示。体型・眉・ヘア・肌・服・歯・爪の7軸ごとにタイプコードの意味を解説。自分のタイプを他のタイプと比較して、変容の旅の地図を俯瞰できます。',
  alternates: { canonical: 'https://www.fineme.me/types' },
  openGraph: {
    title: '全119タイプ一覧 — New Me Type Map | Fineme',
    description: '自分のタイプは119通りのどこにいるのか。MBTIのように、自分を客観視できる外見変容タイプ一覧。',
