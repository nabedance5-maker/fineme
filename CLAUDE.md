...
5. `/home/nabedance5/MyBrain/raw/20260714.md` — Finemeの重要な一次会話。Find New Me.／愛の循環／失恋を入口に「自分の人生を磨く」ことを本体とするブランド・YouTube方針
6. `/home/nabedance5/MyBrain/raw/20260714Geminiの分析.md` — 上記を検討するための外部AI分析。数値・市場推定・強者/復讐/教祖化の提案は仮説であり、そのまま採用しない
...
- Mirror・Me Scan・New Me Map・Navi・関連LP・YouTube導線を**実装または改善判断する前**は、上記の20260714一次会話を必ず読み直す。要約は `~/MyBrain/wiki/2026-07-14-FinemeブランドとYouTube戦略.md`。
