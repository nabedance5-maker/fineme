      ...
      // 全ページ: セキュリティヘッダー
      {
        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'geolocation=(), microphone=()' },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; style-src 'self' 'unsafe-inline' https:; img-src 'self' data: blob: https:; connect-src 'self' https:; font-src 'self' data:; object-src 'none'; frame-ancestors 'none'; base-uri 'self';"
          },
        ],
      },
    ];
